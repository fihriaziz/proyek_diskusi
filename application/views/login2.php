...
<div class="container">
	<div class="row">
		<div class="panel panel-primary panel-body" style="padding: 5px;">
			<div class="col-lg-12 col-sm-12"><img src="<?php echo base_url('assets/pic_sys/login.png')?>" class="col-sm-12 col-xs-12"></div>

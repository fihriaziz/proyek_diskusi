  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="<?php echo base_url('Admin/user/1')?>" class="sl-menu-link active">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
        ...
        <div class="row">
          <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40" id="table">
              ...
              <p class="mg-b-20 mg-sm-b-30"><button class="btn btn-outline-primary active" id="mhs">Mahasiswa</button> <a href="<?php echo base_url('Admin/user/2');?>"><button class="btn btn-outline-primary" id="dsn">Dosen</button></a> <a href="<?php echo base_url('Admin/input_mhs_view');?>"><button style="float: right;" class="btn btn-primary">+ Tambah User</button></a></p>
                ...
                <table id="datatable1" class="table display responsive nowrap">
                  ...
                  <?php foreach($mhs->result() as $m){ ?>
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('Admin/update_mhs/'.$m->id_user.'/'.$m->id_mhs);?>"><button class="btn btn-sm btn-warning">Edit</button></a> <a href="<?php echo base_url('Admin/delete_mhs/'.$m->id_user.'/'.$m->id_mhs);?>"><button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-info">Delete</button></a></td>
                    </tr>
<!--                     <div class="modal fade" id="modal-info">
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            <?php echo form_open_multipart('Admin/delete_mhs/'.$m->id_user.'/'.$m->id_mhs);?>

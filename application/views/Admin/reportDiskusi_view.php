  ...
  <body>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Laporan Report Diskusi</span>
      </nav>
      ...
      <div class="container">
        ...
        <div class="sl-pagebody col-sm-12">
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">LAPORAN REPORT DISKUSI</h2>
              <?php foreach($reportDiskusi->result() as $r){ ?>
                <table class="table table-bordered">
                  <tr>
                    <td style="font-size: 18px;"><?php echo $r->nama ?> melaporkan bahwa diskusi "<a href="<?php echo base_url('Admin/diskusi/'.$r->id_diskusi) ?>"><?php echo $r->judul ?></a>" tidak pantas</td>
                    <td style="font-size: 18px; width: 240px;"><?php echo $r->tgl_report; ?></td>
                  </tr>
                </table>
              <?php } ?>
              <?php if($reportDiskusi->num_rows() == 0){ ?>
                <center><h4>Tidak Ada Report</h4></center>
              <?php } ?>
            </div>
          </div>
        </div><!-- end pagebody -->

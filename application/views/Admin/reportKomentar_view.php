  ...
  <body>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Laporan Report Komentar</span>
      </nav>
      ...
      <div class="container">
        ...
        <div class="sl-pagebody col-sm-12">
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">LAPORAN REPORT KOMENTAR</h2>
              <?php 
              foreach($reportKomentar->result() as $r){ ?>
                <table class="table table-bordered">
                  <tr>
                    <td style="font-size: 18px;"><?php echo $r->nama ?> melaporkan bahwa komentar "<a href="#" id="detail"><?php echo $r->isi_komentar ?></a>" tidak pantas</td>
                    <td style="font-size: 18px; width: 240px;"><?php echo $r->tgl_report; ?></td>
                    <td style="width: 80px;"><center><a href="<?php echo base_url('Admin/hapus_komen/'.$r->id_diskusi.'/'.$r->id_komentar)?>"><span class="icon ion-trash-b" style="font-size: 20px;"></span></a></center></td>
                  </tr>
                </table>
              <?php } ?>
            </div>

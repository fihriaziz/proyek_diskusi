        ...
        <div class="row">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4" style="margin-top: 20px;">
              <h6 class="card-body-title">Form Edit Data Mahasiswa</h6><br>
              <?php echo form_open_multipart('Admin/update_mhs2');?>
              <?php foreach($mhs->result() as $m){ ?>
              <input type="hidden" name="id_mhs" value="<?php echo $m->id_mhs;?>">
              ...
              <div class="row">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="nim" placeholder="Masukan NIM" value="<?php echo $m->nim; ?>">
                </div>
              </div><!-- row -->
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Nama Lengkap: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Lengkap" value="<?php echo $m->nama; ?>">
                </div>
              </div>
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <select class="form-control select2" name="jk" data-placeholder="Jenis Kelamin">
                    <option value="<?php echo $m->jk; ?>"><?php echo $m->jk; ?></option>
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <select class="form-control select2" name="prodi" data-placeholder="Prodi">
                    <option value="<?php echo $m->prodi; ?>"><?php echo $m->prodi; ?></option>
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="semester" placeholder="Masukan Semester" value="<?php echo $m->semester; ?>">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Email: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="email" placeholder="Masukan Email" value="<?php echo $m->email; ?>">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Alamat: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <textarea rows="2" class="form-control" name="alamat" placeholder="Masukan Alamat"><?php echo $m->alamat; ?></textarea>
                </div>
              </div>
              <?php } ?>
              <?php foreach($user->result() as $m){ ?>
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="username" placeholder="Masukan Username" value="<?php echo $m->username;?>">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Password: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="password" class="form-control" name="password" placeholder="Masukan Password" value="<?php echo $m->password;?>">
                </div>
              </div>
              <?php } ?>

  ...
  <body>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Edit Dosen</span>
      </nav>
        ...
        <div class="row">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4" style="margin-top: 20px;">
              <h6 class="card-body-title">Form Edit Data Dosen</h6><br>
              <?php echo form_open_multipart('Admin/update_dsn2');?>
              <?php foreach($dsn->result() as $d){ ?>
              <input type="hidden" name="id_dosen" value="<?php echo $d->id_dosen;?>">
              <input type="hidden" name="status" value="<?php echo $d->status;?>">
              <div class="row">
                <label class="col-sm-4 form-control-label">NIP: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="nip" placeholder="Masukan NIP" value="<?php echo $d->nip; ?>">
                </div>
              </div><!-- row -->
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Nama Lengkap: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Lengkap" value="<?php echo $d->nama; ?>">
                </div>
              </div>
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <select class="form-control select2" name="jk" data-placeholder="Jenis Kelamin">
                    <option label="Pilih Jenis Kelamin" value="<?php echo $d->jk; ?>"><?php echo $d->jk; ?></option>
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="email" placeholder="Masukan Email" value="<?php echo $d->email; ?>">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Alamat: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <textarea rows="2" class="form-control" name="alamat" placeholder="Masukan Alamat"><?php echo $d->alamat; ?></textarea>
                </div>
              </div>
              <?php } ?>
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="username" placeholder="Masukan Username" value="<?php echo $d->username; ?>">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Password: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="password" class="form-control" name="password" placeholder="Masukan Password" value="<?php echo $d->password; ?>">
                </div>
              </div>
              <?php } ?>
